...
export interface AdminAuthState { user?: AdminUser; loading: boolean; message?: string; login(email: string, password: string): Promise<void>; logout(): Promise<void>; refresh(): Promise<void> }

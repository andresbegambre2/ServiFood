...
import { RequireKitchen } from './layouts/KitchenAccess'
...
export default function App() { return <BrowserRouter><Routes>
  ...
  <Route path="kitchen" element={<AdminAuthProvider><Routes><Route element={<RequireKitchen />}><Route index element={<KitchenPage />} /></Route></Routes></AdminAuthProvider>} />

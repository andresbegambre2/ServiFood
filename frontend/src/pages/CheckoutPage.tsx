...
export function CheckoutPage() {
  const cart = useCart(); const { data } = useStorefront(); const navigate = useNavigate()
  ...
  const [quote, setQuote] = useState<CheckoutQuote | null>(null); const [quoteError, setQuoteError] = useState('')
  ...
  const methods = paymentMethodsFor(draft.deliveryType, data?.business.transfer.configured ?? false)

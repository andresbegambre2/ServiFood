...
export interface KitchenOrder { publicNumber: string; createdAt: string; deliveryType: DeliveryType; status: OrderStatus; items: { name: string; quantity: number; notes?: string; extras: string[] }[] }
